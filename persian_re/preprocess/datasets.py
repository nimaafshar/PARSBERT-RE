...
class PerlexDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, tokenizer: BertTokenizer, texts: List[str], targets: List[int] = None,
...
def create_data_loader(x: List[str], y: List[int], tokenizer: BertTokenizer, max_len: int, batch_size: int,
                       label2id: Dict[str, int]) -> torch.utils.data.DataLoader:
    """
    :param x: list of texts
    :param y: list of class id's corresponding to elements of x
